        ...
        <div class="mx-auto twitter-box">
          ...
          <div class="boad mt-4">
            <Timeline
              :id="user_id"
              source-type="profile"
              :options="{ tweetLimit: '5', width: '450' }"
            />
          </div>
        </div>
      </CarouselCardItem>
      <CarouselCardItem>
        <div class="mx-auto ajax-box">
          <span>
            ...
            >
              <img
                src="@/assets/img/qiita_favicon.png"
                alt
                class="qiita_pic"
              > Qiita
            </div>
